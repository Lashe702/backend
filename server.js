...
const port = 3000;
const uri = "mongodb+srv://admin-sdev255:admin-password@mo8db.u9y4rjt.mongodb.net/faux-school?retryWrites=true&w=majority";
...
Course.findByIdAndDelete(req.body.coursID, (err) => {
...
app.listen(port, () => console.log('Appp Running'));
